...
const portfolioItems = [
  {
    ...
    description: 'Video editing dengan style speed ramp dan pace cepat',
    icon: Video,
    color: 'from-purple-500 to-indigo-500',
    link: 'https://www.instagram.com/reel/DAY4ZaSBzu3/?igsh=dHVzNnAzMTk5ZXUz',
  },
  {
    id: 2,
    title: 'Creative gameplay Reel',
    category: 'Video Editing',
    description: 'Konten video gameplay dengan style editing yang absurd dan dinamis',
    icon: Video,
    color: 'from-blue-500 to-cyan-500',
    link: 'https://www.instagram.com/reel/DIO7n9SyF5m/?utm_source=ig_web_button_share_sheet',
  },
  {
    id: 3,
    title: 'Advertising reel Edit',
    category: 'Video Editing',
    description: 'Editing video iklan pendek dengan storytelling visual',
    icon: Video,
    color: 'from-pink-500 to-rose-500',
    link: 'https://www.instagram.com/reel/DRbYP0REdER/?utm_source=ig_web_button_share_sheet',
  },
  {
    id: 4,
    title: 'Another creative gampalay reel',
    category: 'Video Editing',
    description: 'Video gameplay dengan style edit absurd dan menghibur',
    icon: Video,
    color: 'from-orange-500 to-amber-500',
    link: 'https://www.instagram.com/reel/DIi8dFDSVke/?utm_source=ig_web_button_share_sheet',
  },
  {
    id: 5,
